...
const createProduct = async (req, res) => {
  try {
    ...
    if (!imageUrl || !title || !description) return res.status(400).json(variable.NOT_EMPTY);
...
const updateProduct = async (req, res) => {
  try {
    ...
    if (!imageUrl || !title || !description) return res.status(200).json(variable.NOT_EMPTY);
